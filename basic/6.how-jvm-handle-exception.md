众所周知，异常处理的两大组成要素是**抛出异常**和**捕获异常**。这两大要素共同实现程序控制流的非正常转移。
...
#### [上一篇：5.  JVM如何执行方法调用（下）？](5.how-jvm-execute-method-invocation.md)

#### [下一篇：7.  JVM如何实现反射？](7.how-jvm-implement-reflection.md)

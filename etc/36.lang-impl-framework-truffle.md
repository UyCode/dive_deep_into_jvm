...
1. 对于 Java 虚拟机语言（Java、Scala），我比较的是使用 C2 的 HotSpot 虚拟机和使用 Graal 的 HotSpot 虚拟机。

2. 对于 Ruby，我比较的是运行在 HotSpot 虚拟机之上的 JRuby 和 Truffle Ruby。

3. 对于 R，我比较的是 GNU R 和基于 Truffle 的 FastR。

4. 对于 C/C++，我比较的是利用 LLVM 编译器生成的二进制文件和基于 Truffle 的 Sulong。

5. 对于 JavaScript，我比较的是 Google 的 V8 和 Graal.js。
...
#### [上一篇：用Java编译Java](35.compile-java-with-java.md)
#### [下一篇：SubstrateVM: AOT编译框架](37.substrateVM.md)
